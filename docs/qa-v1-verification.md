...
- Saved blocks can connect to any loaded block, including themselves. Incoming whole-block and quote connections appear as collapsed `Connected from N blocks` backlink rows, and expanded backlink cards navigate to the source block.
